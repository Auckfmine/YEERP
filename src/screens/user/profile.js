  ...
  return (
    <SafeAreaView style={styles.container}>
      <AwesomeAlert
        ...
        showProgress={false}
        title="Notification"
        message="Cette page est juste pour le test pas encore de design"
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.statsContainer}>
          <View style={styles.statsBox}>
            ...
            <Text style={[styles.text, styles.subText]}>Postes</Text>
          </View>
          <View
            style={[
              styles.statsBox,
            ...
            <Text style={[styles.text, styles.subText]}>Suiveurs</Text>
          </View>
          <View style={styles.statsBox}>
            <Text style={[styles.text, {fontSize: 24}]}>302</Text>
            <Text style={[styles.text, styles.subText]}>Suit</Text>
          </View>
        </View>
